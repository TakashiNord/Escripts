...
proc DG_GROUPS { db2 } {
  ...
  foreach TABLE_NAME $TABLE_LIST {
    ...
    for {set i 0} {$i < $cntID} {incr i} {
      ...
      #--DG_GROUPS_DESC
      $db2 "UPDATE DG_GROUPS_DESC SET ID_GROUP=$id_new WHERE ID_GROUP=$maxID"
      $db2 commit

      #--  ID_OBJECT
      set TABLE_LIST2 [ list DG_KDU_JOURNAL DG_KDU_JOURNAL_OLD ]
      changeTable $db2 $id_new $maxID "ID_OBJECT" $TABLE_LIST2

      #--DG_LIST
      $db2 "UPDATE DG_LIST SET ID_NODE=$id_new WHERE ID_NODE=$maxID"
      $db2 commit
...
proc S_GROUPS { db2 } {
  ...
  foreach TABLE_NAME $TABLE_LIST {
    ...
    for {set i 0} {$i < $cntID} {incr i} {
      ...
      $db2 "UPDATE $TABLE_NAME SET ID=$id_new WHERE ID=$id_old"
      $db2 commit
      ...
      changeTable $db2 $id_new $maxID "ID_GROUP" $TABLE_LIST2

      #--S_USERS
      $db2 "UPDATE S_USERS SET ID_NODE=$id_new WHERE ID_NODE=$maxID"
      $db2 commit
...
proc S_USERS { db2 } {
  ...
  foreach TABLE_NAME $TABLE_LIST {
    ...
    for {set i 0} {$i < $cntID} {incr i} {
      ...
      S_USERS_TABLE $db2 $id_new $maxID 1
    }
...
proc US_BUTTON_DESC { db2 } {
  ...
  foreach TABLE_NAME $TABLE_LIST {
    ...
    for {set i 0} {$i < $cntID} {incr i} {
      ...
      #--US_MENU
      $db2 "UPDATE US_MENU SET ID_BUTTON=$id_new WHERE ID_BUTTON=$maxID"
      $db2 commit
...
proc SYS_APD { db2 } {
  ...
  foreach TABLE_NAME $TABLE_LIST {
    ...
    for {set i 0} {$i < $cntID} {incr i} {
      ...
      #--SYS_APPL
      $db2 "UPDATE SYS_APPL SET ID_NODE=$id_new WHERE ID_NODE=$maxID"
      $db2 commit
...
proc AD_DIR { db2 } {
  ...
  foreach TABLE_NAME $TABLE_LIST {
    ...
    for {set i 0} {$i < $cntID} {incr i} {
      ...
      #--AD_DIR
      $db2 "UPDATE AD_DIR SET ID_PARENT=$id_new WHERE ID_PARENT=$maxID"
      $db2 commit


      #--J_SHDV
      if {[checkTable $db2 "J_SHDV" "ID_DEVICE"]} {
        $db2 "UPDATE J_SHDV SET ID_DEVICE=$id_new WHERE ID_DEVICE=$maxID"
        $db2 commit
      }
      #--  ID_SERVER_NODE
      set TABLE_LIST2 [ list AD_JRNL AD_SINFO AD_SINFO_INI ]
      changeTable $db2 $id_new $maxID "ID_SERVER_NODE" $TABLE_LIST2
      #--  ID_NODE
      set TABLE_LIST2 [ list AD_COMCARD AD_IPINFO AD_LIST AD_MBII AD_MODEM AD_NCARD AD_PORT AD_SEGMENT ]
      changeTable $db2 $id_new $maxID "ID_NODE" $TABLE_LIST2
      #--AD_HOSTS
      $db2 "UPDATE AD_HOSTS SET ID_SYSTEM_NODE=$id_new WHERE ID_SYSTEM_NODE=$maxID"
      $db2 commit
      $db2 "UPDATE AD_HOSTS SET ID_HOST_NODE=$id_new WHERE ID_HOST_NODE=$maxID"
      $db2 commit
      #--AD_PINFO
      $db2 "UPDATE AD_PINFO SET ID_INTRFACE_NODE=$id_new WHERE ID_INTRFACE_NODE=$maxID"
      $db2 commit
      #--AD_SEGMENT
      $db2 "UPDATE AD_SEGMENT SET ID_PORT_NODE=$id_new WHERE ID_PORT_NODE=$maxID"
      $db2 commit
...
proc AD_DTYP { db2 } {
  ...
  foreach TABLE_NAME $TABLE_LIST {
    ...
    for {set i 0} {$i < $cntID} {incr i} {
      ...
      #--AD_DIR
      $db2 "UPDATE AD_DIR SET ID_TYPE=$id_new WHERE ID_TYPE=$maxID"
      $db2 commit
...
proc AD_LIST { db2 } {
  ...
  foreach TABLE_NAME $TABLE_LIST {
    ...
    for {set i 0} {$i < $cntID} {incr i} {
      ...
      #--AD_PINFO
      $db2 "UPDATE AD_PINFO SET ID_PARAM=$id_new WHERE ID_PARAM=$maxID"
      $db2 commit
...
proc AST_ORG { db2 } {
  ...
  foreach TABLE_NAME $TABLE_LIST {
    ...
    for {set i 0} {$i < $cntID} {incr i} {
      ...
      #--AST_ORG
      $db2 "UPDATE AST_ORG SET ID_PARENT=$id_new WHERE ID_PARENT=$maxID"
      $db2 commit



      #--AST_PERSONNEL
      $db2 "UPDATE AST_PERSONNEL SET ID_NODE=$id_new WHERE ID_NODE=$maxID"
      $db2 commit

      #-- ID_ORG
      set TABLE_LIST2 [ list AST_LINK OBJ_TREE RSDU_USERS FEED_ORG_LINK ]
      changeTable $db2 $id_new $maxID "ID_ORG" $TABLE_LIST2
...
proc AST_CNT { db2 } {
  ...
  foreach TABLE_NAME $TABLE_LIST {
    ...
    for {set i 0} {$i < $cntID} {incr i} {
      ...
      #--AST_CNT
      $db2 "UPDATE AST_CNT SET ID_PARENT=$id_new WHERE ID_PARENT=$maxID"
      $db2 commit


      #--AST_CNT_LIST
      $db2 "UPDATE AST_CNT_LIST SET ID_NODE=$id_new WHERE ID_NODE=$maxID"
      $db2 commit

      #-- ID_CNT
      set TABLE_LIST2 [ list AST_LINK  OBJ_CNT ]
      changeTable $db2 $id_new $maxID "ID_CNT" $TABLE_LIST2

      #-- ID_SRC_CNT
      set TABLE_LIST2 [ list DG_KDU_JOURNAL DG_KDU_JOURNAL_OLD ]
      changeTable $db2 $id_new $maxID "ID_SRC_CNT" $TABLE_LIST2
...
proc VP_GROUP { db2 } {
  ...
  foreach TABLE_NAME $TABLE_LIST {
    ...
    for {set i 0} {$i < $cntID} {incr i} {
      ...
      $db2 commit
      #--VP_GROUP
      $db2 "UPDATE VP_GROUP SET ID_PARENT=$id_new WHERE ID_PARENT=$maxID"
      $db2 commit

      #--VP_PANEL
      $db2 "UPDATE VP_PANEL SET ID_NODE=$id_new WHERE ID_NODE=$maxID"
      $db2 commit
...
proc VP_PANEL { db2 ID_TABLE ID_APPL } {
  ...
  foreach TABLE_NAME $TABLE_LIST {
    ...
    for {set i 0} {$i < $cntID} {incr i} {
      ...
      #--VP_CTRL
      $db2 "UPDATE VP_CTRL SET ID_PANEL=$id_new WHERE ID_PANEL=$maxID"
      $db2 commit
      ...
      #--VP_PARAMS  ID_TABLE=40 - VP_PANEL_LST
      $db2 "UPDATE VP_PARAMS SET ID_PARAM=$id_new WHERE ID_PARAM=$maxID AND ID_TABLE=$ID_TABLE"
      $db2 commit

      #--VS_REGIM_TUNE  ID_TABLE=40 - VP_PANEL_LST
      $db2 "UPDATE VS_REGIM_TUNE SET ID_PARAM=$id_new WHERE ID_PARAM=$maxID AND ID_TABLE=$ID_TABLE"
      $db2 commit
...
proc VP_CTRL { db2 } {
  ...
  foreach TABLE_NAME $TABLE_LIST {
    ...
    for {set i 0} {$i < $cntID} {incr i} {
      ...
      #--VP_PARAMS
      $db2 "UPDATE VP_PARAMS SET ID_CTRL=$id_new WHERE ID_CTRL=$maxID"
      $db2 commit
...
proc VS_GROUP { db2 } {
  ...
  foreach TABLE_NAME $TABLE_LIST {
    ...
    for {set i 0} {$i < $cntID} {incr i} {
      ...
      $db2 commit
      #--VS_GROUP
      $db2 "UPDATE VS_GROUP SET ID_PARENT=$id_new WHERE ID_PARENT=$maxID"
      $db2 commit

      #--VS_FORM
      $db2 "UPDATE VS_FORM SET ID_NODE=$id_new WHERE ID_NODE=$maxID"
      $db2 commit
...
proc VS_COMP { db2 } {
  ...
  foreach TABLE_NAME $TABLE_LIST {
    ...
    for {set i 0} {$i < $cntID} {incr i} {
      ...
      #--VS_REGIM_TUNE
      $db2 "UPDATE VS_REGIM_TUNE SET ID_OWNLST=$id_new WHERE ID_OWNLST=$maxID"
      $db2 commit
      #--TAG_POSITION
      $db2 "UPDATE TAG_POSITION   SET ID_COMP=$id_new WHERE ID_COMP=$maxID"
      $db2 commit
  ...
  foreach TABLE_NAME $TABLE_LIST {
    ...
    for {set i 0} {$i < $cntID} {incr i} {
      ...
      if {$id_old==$id_new} { continue ; }
        ...
        $db2 commit
        #--RPT_DIR
        $db2 "UPDATE RPT_DIR SET ID_PARENT=$id_new WHERE ID_PARENT=$maxID"
        $db2 commit


        #--RPT_LST
        $db2 "UPDATE RPT_LST SET ID_NODE=$id_new WHERE ID_NODE=$maxID"
        $db2 commit
...
proc RPT_LST { db2 ID_TABLE ID_APPL } {
  ...
  foreach TABLE_NAME $TABLE_LIST {
    ...
    for {set i 0} {$i < $cntID} {incr i} {
      ...
      #--RPT_PARAMS
      $db2 "UPDATE RPT_PARAMS SET ID_REPORT=$id_new WHERE ID_REPORT=$maxID"
      $db2 commit
      ...
      set TABLE_LIST [ list VP_PARAMS VS_REGIM_TUNE ]
      foreach T_NAME $TABLE_LIST {
        $db2 "UPDATE $T_NAME SET ID_PARAM=$id_new WHERE ID_PARAM=$maxID AND ID_TABLE=$ID_TABLE"
        $db2 commit
      }
...
proc R_GROUP { db2 } {
  ...
  foreach TABLE_NAME $TABLE_LIST {
    ...
    for {set i 0} {$i < $cntID} {incr i} {
      ...
      $db2 commit
      #--R_GROUP
      $db2 "UPDATE R_GROUP SET ID_PARENT=$id_new WHERE ID_PARENT=$maxID"
      $db2 commit

      #--R_KADR
      $db2 "UPDATE R_KADR SET ID_NODE=$id_new WHERE ID_NODE=$maxID"
      $db2 commit
...
proc R_KADR { db2 ID_TABLE ID_APPL } {
  ...
  foreach TABLE_NAME $TABLE_LIST {
    ...
    for {set i 0} {$i < $cntID} {incr i} {
      ...
      #--R_PSETS
      $db2 "UPDATE R_PSETS SET ID_KADR=$id_new WHERE ID_KADR=$maxID"
      $db2 commit
...
proc DBE_STORAGE { db2 } {
  ...
  foreach TABLE_NAME $TABLE_LIST {
    ...
    for {set i 0} {$i < $cntID} {incr i} {
      ...
      #--DBE_JOB
      $db2 "UPDATE DBE_JOB SET ID_STORAGE=$id_new WHERE ID_STORAGE=$maxID"
      $db2 commit
...
proc DBE_JOB { db2 } {
  ...
  VALUES ($maxID,1,0,'TEXTRENAMETEXT','--','--',1,0,0,0) "
    ...
    for {set i 0} {$i < $cntID} {incr i} {
      ...
      changeTable $db2 $id_new $maxID "ID_JOB" $TABLE_LIST2
...
proc DBE_ACTION { db2 } {
  ...
  VALUES ($maxID,1,'TEXTRENAMETEXT','--','--',0,0,2,0,0,'',0,'') "
    ...
    for {set i 0} {$i < $cntID} {incr i} {
      ...
      changeTable $db2 $id_new $maxID "ID_ACTION" $TABLE_LIST2
...
proc ARC1 { db2 } {
  ...
  foreach TABLE_NAME $TABLE_LIST {
    ...
    for {set i 0} {$i < $cntID} {incr i} {
      ...
      changeTable $db2 $id_new $maxID "ID_SPROFILE" $TABLE_LIST2
...
(select id from sys_db_part where define_alias like 'DA_SUBSYST' ))))"
    ...
    for {set i 0} {$i < $cntID} {incr i} {
      ...
      set TABLE_LIST2 [ list DA_ARC  DA_PARGROUP_TUNE DA_PROFILE DA_VAL ]
      foreach T_NAME $TABLE_LIST2 {
        $db2 "UPDATE $T_NAME SET ID_PARAM=$id_new WHERE ID_PARAM=$maxID"
        $db2 commit
      }

      #--DA_SRC_CHANNEL  ID_OWNLST
      $db2 "UPDATE DA_SRC_CHANNEL SET ID_OWNLST=$id_new WHERE ID_OWNLST=$maxID"
      $db2 commit

      #--J_MAILDISP  ID_DIRECTORY
      $db2 "UPDATE J_MAILDISP SET ID_DIRECTORY=$id_new WHERE ID_DIRECTORY=$maxID"
      $db2 commit
...
proc DA_DEV { db2 } {
    ...
    for {set i 0} {$i < $cntID} {incr i} {
      ...
      changeTable $db2 $id_new $maxID "ID_DEV" $TABLE_LIST2
...
proc DA_DEV_DESC { db2 } {
  ...
  VALUES ($maxID,1,1,$maxID,'TEXTRENAMETEXT',1,405,1,null,1)"
    ...
    for {set i 0} {$i < $cntID} {incr i} {
      ...
      #--DA_PARAM  ID_POINT
      $db2 "UPDATE DA_PARAM SET ID_POINT=$id_new WHERE ID_POINT=$maxID"
      $db2 commit
...
proc DA_CAT { db2 } {
    ...
    for {set i 0} {$i < $cntID} {incr i} {
      ...
      #-- ID_DEVICE
      set TABLE_LIST2 [ list J_DADV  J_DAPARAMSTATE ]
      changeTable $db2 $id_new $maxID "ID_DEVICE" $TABLE_LIST2
...
proc OBJ_EL_PIN { db2 } {
  ...
  foreach TABLE_NAME $TABLE_LIST {
    ...
    for {set i 0} {$i < $cntID} {incr i} {
      ...
      #--  ID_PIN
      set TABLE_LIST2 [ list MEAS_LIST TAG_LIST DMS_BNODE_PINS DMS_CALC_RESULT_MEAS ]
      changeTable $db2 $id_new $maxID "ID_PIN" $TABLE_LIST2

      #--  ID_EL_PIN
      set TABLE_LIST2 [ list OBJ_AUX_EL_PIN OBJ_LIMIT_SET ]
      changeTable $db2 $id_new $maxID "ID_EL_PIN" $TABLE_LIST2
...
proc OBJ_CONN_NODE { db2 } {
  ...
  foreach TABLE_NAME $TABLE_LIST {
    ...
    for {set i 0} {$i < $cntID} {incr i} {
      ...
      changeTable $db2 $id_new $maxID "ID_CONN_NODE" $TABLE_LIST2
...
proc OBJ_MODEL { db2 } {
  ...
  foreach TABLE_NAME $TABLE_LIST {
    ...
    for {set i 0} {$i < $cntID} {incr i} {
      ...
      changeTable $db2 $id_new $maxID "ID_MODEL" $TABLE_LIST2
...
proc TAG_LIST { db2 } {
  ...
  foreach TABLE_NAME $TABLE_LIST {
    ...
    for {set i 0} {$i < $cntID} {incr i} {
      ...
      changeTable $db2 $id_new $maxID "ID_TAG" $TABLE_LIST2
...
proc SYS_WAVE { db2 } {
 ...
 WRPT_CAT WRPT_TMPL_CAT ]
      ...
      changeTable $db2 $id_new $maxID "ID_FILEWAV" $TABLE_LIST2
...
proc SYS_TBLLST_1 { db2 ind1 ind2 } {
       ...
       #--  ID_LSTTBL
       set TABLE_LIST2 [ list AD_SINFO ARC_SERVICES_INFO DA_PC R_MANUAL_PARAMS SYS_APP_SERV_LST SYS_FTR SYS_TBLLNK SYS_TREE21 ]
...
proc SYS_MEAS_TYPES { db2 shift } {
  ...
  foreach TABLE_NAME $TABLE_LIST {
    ...
    # insert temp record
    set maxID [ expr int($maxID)+1 ]
    set strSQL0 "INSERT INTO $TABLE_NAME (ID,ID_TYPE,NAME) VALUES ($maxID,1001,'TEXTRENAMETEXT') "
    $db2 $strSQL0
    $db2 commit
...
proc SYS_PUNIT { db2 shift } {
 ...
 OBJ_MODEL_PARAM OBJ_PARAM SYS_MEAS_TYPES SYS_OTYP_PARAM SYS_PARAM_TYPES VS_FORM_PARAMTYPE EA_CHANNELS_DESC EA_RATES_DESC ]
      ...
      changeTable $db2 $id_new $maxID "ID_UNIT" $TABLE_LIST2
...
proc SYS_PTYP { db2 shift } {
  ...
  foreach TABLE_NAME $TABLE_LIST {
    ...
    # insert temp record
    set maxID [ expr int($maxID)+1 ]
    set strSQL0 "INSERT INTO $TABLE_NAME (ID,NAME,ID_GTYP) VALUES ($maxID,'TEXTRENAMETEXT',1) "
    $db2 $strSQL0
    $db2 commit
    ...
    for {set i 0} {$i < $cntID} {incr i} {
      ...
      #--  ID_PTYPE
      set TABLE_LIST2 [ list OBJ_LIMIT ]
      changeTable $db2 $id_new $maxID "ID_PTYPE" $TABLE_LIST2
...
proc SYS_PARAM_TYPES { db2 shift } {
  ...
  foreach TABLE_NAME $TABLE_LIST {
    ...
    for {set i 0} {$i < $cntID} {incr i} {
      ...
      changeTable $db2 $id_new $maxID "ID_PARAM_TYPE" $TABLE_LIST2
...
proc SYS_DB_PART { db2 shift } {
  ...
  foreach TABLE_NAME $TABLE_LIST {
    ...
    for {set i 0} {$i < $cntID} {incr i} {
      ...
      set strSQL3 "UPDATE $TABLE_NAME SET ID_PARENT=$id_new WHERE ID_PARENT=$maxID"
      $db2 $strSQL3
      $db2 commit
