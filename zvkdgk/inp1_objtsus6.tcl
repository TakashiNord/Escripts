...
proc GetElem { fpid level } {
  ...
  set sql4 "Select ID, ID_PARENT ,ID_TYPE, NAME , ALIAS from  OBJECTS_INP where ID_PARENT=$fpid"
...
# открываем - создаем бд
  ...
  foreach PowerObjectId $PowerObject {
    ...
    set sql33 "Select ID, ID_PARENT ,ID_TYPE, NAME, ALIAS from  OBJECTS_INP where ID_PARENT is null" ; # and ID=$PowerObjectId 
