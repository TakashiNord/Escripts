# interface generated by SpecTcl version 1.1 from C:/Rsdu5/winui.ui
...
proc winui_ui {root args} {
  ...
  grid columnconfigure $root 1 -weight 1 -minsize 102
  ...
  grid columnconfigure $root 7 -weight 0 -minsize 8
...
#=======================================
  ...
  set sD 0 ; set sUV 0 ; set sI 0 ;
  foreach x $ll {
    set state [dict get $x "State"]
    if {$state=="Isolated"} { incr sI ; }
    if {$state=="UnderVoltage"} { incr sUV ; }
    if {$state=="Damaged"} { incr sD ; }
  }

  OUTtext "\nAll elements=$li  |  Isolated=$sI  UnderVoltage=$sUV  Damaged=$sD\n"
...
#=======================================
 ...
 set err ""
   ...
   set dj [json::json2dict $jsonStr] ; # получаем массив списков
